        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-sm text-slate-500 mt-1">
              Live · Last updated 5 minutes ago based on wearable data
            </div>
          </div>
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-4 rounded-lg bg-white p-6 border shadow-sm">
            ...
            <div className="flex items-center gap-6 mt-4">
              <div className="w-28 h-28 rounded-full bg-slate-100 flex items-center justify-center text-2xl font-bold">
                88%
              </div>
              <div className="text-sm text-slate-600">
                <div className="font-medium">
                  Optimal performance zone for upcoming match
                </div>
            ...
            <div className="mt-4 space-y-3">
              <div>
                ...
                <div className="w-full bg-slate-100 rounded h-2 mt-1">
                  <div
                    className="h-2 bg-rose-200 rounded"
                    style={{ width: "8%" }}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-slate-100 rounded h-2 mt-1">
                  <div
                    className="h-2 bg-amber-200 rounded"
                    style={{ width: "25%" }}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-slate-100 rounded h-2 mt-1">
                  <div
                    className="h-2 bg-emerald-200 rounded"
                    style={{ width: "67%" }}
                  />
                </div>
              </div>
              ...
              <div className="mt-3 bg-indigo-50 border rounded p-3 text-sm text-indigo-700">
                <strong>AI Insight:</strong> High hamstring load detected in
                defensive unit. Recommend rotation for tomorrow's drill.
              </div>
            </div>
          </div>
            ...
            <div className="mt-4 h-40">
              ...
              >
                <polyline
                  ...
                  stroke="#5954E6"
                  strokeWidth="3"
                  points="0,120 80,100 160,110 240,80 320,95 400,70"
                />
                <polyline
                  fill="none"
                  stroke="#F59E0B"
                  strokeWidth="2"
                  points="0,110 80,115 160,100 240,95 320,105 400,90"
                />
              </svg>
            </div>
            <div className="text-xs text-slate-400 mt-3">
              Coach Note: Squad workload has increased by 15% over the last 3
              days. Monitor recovery.
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between p-3 rounded border bg-white">
              ...
              <div className="w-40">
                ...
                <div className="w-full bg-slate-100 rounded h-3 mt-1">
                  <div
                    className="h-3 bg-rose-500 rounded"
                    style={{ width: "92%" }}
                  />
                </div>
              </div>
              ...
              <div className="w-36 text-right">
                <AppButton className="bg-rose-100 text-rose-700">
                  Suggest Rest
                </AppButton>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between mt-4">
                <div>
                  ...
                  <div className="text-xs text-slate-500 mt-2">
                    Team sleep quality and heart rate variability (HRV) are
                    trending positively.
                  </div>
                </div>
                <div>
                  <AppButton className="bg-indigo-600 text-white">
            ...
            <div className="rounded-lg bg-white p-4 border flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-slate-500">
                  Fast tools for incident response
                </div>
              </div>
              <div className="flex gap-3">
                <AppButton className="bg-slate-50">
                  Medical Incident Report
                </AppButton>
                <AppButton className="bg-slate-50">
                  Position Load Analysis
                </AppButton>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-lg bg-white p-4 border space-y-3">
              ...
              <div className="rounded border-l-4 border-rose-200 bg-rose-50 p-3">
                ...
                <div className="text-xs text-slate-600 mt-1">
                  Player Marcus V. reached 92% injury risk threshold.
                </div>
              ...
              <div className="rounded border-l-4 border-amber-200 bg-amber-50 p-3">
                ...
                <div className="text-xs text-slate-600 mt-1">
                  Player David K. showing high metabolic stress trends.
                </div>
              ...
              <div className="rounded border-l-4 border-emerald-200 bg-emerald-50 p-3">
                ...
                <div className="text-xs text-slate-600 mt-1">
                  Morning recovery metrics processed for 18 athletes.
                </div>
